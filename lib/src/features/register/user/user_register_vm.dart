...
import 'package:app_agendamento/src/features/register/user/user_register_providers.dart';
...
class UserRegisterVm extends _$UserRegisterVm {
  ...
  Future<void> register({
    ...
    final userRegisterAdminService =
        ref.watch(userRegisterAdminServiceProvider);
    final userDTO = (
      name: name,
      email: email,
      password: password,
    ...
    final registerResult =
        await userRegisterAdminService.execute(userDTO).asyncLoader();
