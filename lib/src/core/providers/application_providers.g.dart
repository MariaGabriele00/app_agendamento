...
String _$agendadoRespositoryHash() =>
    r'f639953db27353a64f5ea3d791bc8e69114c1abc';

/// See also [agendadoRespository].
@ProviderFor(agendadoRespository)
final agendadoRespositoryProvider = Provider<AgendadoRespository>.internal(
  agendadoRespository,
  name: r'agendadoRespositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$agendadoRespositoryHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef AgendadoRespositoryRef = ProviderRef<AgendadoRespository>;
String _$getMyAgendadoHash() => r'fde57ee1c6393bdaaf12b5b3d0f0977473461362';

/// See also [getMyAgendado].
@ProviderFor(getMyAgendado)
final getMyAgendadoProvider = FutureProvider<AgendadoModel>.internal(
  getMyAgendado,
  name: r'getMyAgendadoProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getMyAgendadoHash,
  dependencies: null,
...
typedef GetMyAgendadoRef = FutureProviderRef<AgendadoModel>;
String _$logoutHash() => r'f6693bf5d5912cf34e74445948550330d2622ac5';
